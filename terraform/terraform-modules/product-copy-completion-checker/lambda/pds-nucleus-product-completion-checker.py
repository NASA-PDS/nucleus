...
def create_harvest_configs_and_trigger_nucleus(list_of_product_labels_to_process):
    ...
    try:
        # os.makedirs('/dag-data/, exist_ok=True')
        # harvest_config_file_path = harvest_config_dir + '/harvest_' + file_name + '_' + random_batch_number + '.cfg'
        # harvest_manifest_file_path = harvest_config_dir + '/harvest_manifest_' + file_name + '_' + random_batch_number + '.txt'
        # s3_file_list_file_path = harvest_config_dir + '/s3_file_list_' + file_name + '_' + random_batch_number + '.txt'
...
def trigger_nucleus_workflow(harvest_manifest_file_path, harvest_config_file,
    ...
    #         harvest_manifest_file_path_key + "\":\"" + harvest_manifest_file_path_value + "\",\"" + \
    #         harvest_config_file_path_key + "\":\"" + harvest_config_file_path_value + "\",\"" + \
    #         list_of_data_files_to_copy_file_path_key + "\":\"" + list_of_data_files_to_copy_file_path_value + "\",\"" + \
    #         list_of_product_labels_to_process_key + "\":\"" + list_of_product_labels_to_process_value + "\",\"" + \
    #         harvest_manifest_s3_url_key + "\":\"" + harvest_manifest_s3_url_value + "\",\"" + \
    #         harvest_config_s3_url_key + "\":\"" + harvest_config_s3_url_value + "\",\"" + \
    #         list_of_data_files_to_copy_s3_url_key + "\":\"" +  list_of_data_files_to_copy_s3_url_value + "\"}"
