...
def lambda_handler(event, context):
    ...
    print(s3_url_of_file)

    # TODO implement

    # print(event_json_dict.get("s3").get("Object").get("key"))

    # s3_url_of_file = event_json["s3_url_of_file"]
    # s3_bucket = event_json["s3_bucket"]
    # s3_key = event_json["s3_key"]
